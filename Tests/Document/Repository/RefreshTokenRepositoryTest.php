...
use MichalKvasnicak\Bundle\OAuth2ServerMongoDBBundle\Document\Repository\RefreshTokenRepository;
use Mockery as m;
...
class RefreshTokenRepositoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var m\MockInterface|RefreshTokenRepository
     */
    private $repository;
    ...
    {
        $this->assertInstanceOf('OAuth2\Storage\IRefreshTokenStorage', $this->repository);
    }
    ...
    protected function setUp()
    {
        ...
        $this->repository = m::mock(
            'MichalKvasnicak\Bundle\OAuth2ServerMongoDBBundle\Document\Repository\RefreshTokenRepository'
        )->makePartial();
    }
